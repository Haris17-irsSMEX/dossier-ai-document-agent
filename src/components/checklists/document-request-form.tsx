...
export function DocumentRequestForm({
  ...
  return (
    <form action={updateChecklistItemAction} className="request-form">
      ...
      <input type="hidden" name="phase_slug" value={item.phase_slug || "profile_academic_file"} />
      <input
        type="hidden"
        name="requirement_level"
        value={item.requirement_level || (item.is_required ? "required" : "optional")}
      />
      <input type="hidden" name="condition_note" value={item.condition_note || ""} />
